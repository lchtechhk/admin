...
function delete_item(count){
    ...
    if(confirm('Are You Sure To Remove Item : '+display_count + '?')){
        ...
        console.log("row_order_table : " + item_html);
...
function fill_order_product(){
    ...
    var customer_remark = $("#add_customer_remark").val();
    var order_product_status = $("#add_order_product_status").val();
    ...
    "<input type='hidden' name='order_product["+rowCount+"][customer_remark]' value='"+customer_remark+"'/>"+
    "<input type='hidden' name='order_product["+rowCount+"][order_product_status]' value='"+order_product_status+"'/>"+
    "</td>";
    ...
    td += "<td>"+"<input oninput='calculate_final_price("+''+")' name='order_product["+rowCount+"][final_price]' onkeypress='validate(event)' type='text' value='"+final_price+"'/>"+'<span id="error_display_'+rowCount+'_final_price"'+' class="help-block alert alert-danger hidden">This Field Is Required.</span>'+"</td>";
    td += "<td>"+customer_remark+"</td>";
    td += "<td>"+order_product_status+"</td>";
...
function json_order_product(){
    ...
    for(var i=0; i<rowCount; i++){
        ...
        var customer_remark = $("input[name='order_product["+i+"][customer_remark]']").val();
        var order_product_status = $("input[name='order_product["+i+"][order_product_status]']").val();
        ...
        console.log("json_order_product : " + JSON.stringify(obj));
