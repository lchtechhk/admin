                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-8">
                        {!! Form::text("language_array[".$language->language_id."][name]",
                            empty($result['product_attribute']->language_array[$language->language_id]['name']) ? '' :
                            print_value($result['operation'],$result['product_attribute']->language_array[$language->language_id]['name']),
