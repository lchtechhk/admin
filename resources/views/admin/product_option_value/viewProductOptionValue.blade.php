                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 col-md-4">
                                            {!! Form::text('product_option_value_id', 
                                            empty($result['product_option_value']->product_option_value_id) ? '' : $result['product_option_value']->product_option_value_id,
                                            ...
                                            <select class="form-control field-validate" id="product_option_id" name="product_option_id">
                                                @foreach ($result['view_product_options'] as $product_option)
                                                    <option value="{{ $product_option->product_option_id }}"
                                                        {{print_selected_value($product_option->product_option_id, isset($_POST['product_option_id']) ? $_POST['product_option_id'] : !empty($result['view_product_options']->product_option_id) ? $result['view_product_options']->product_option_id : '')}}>
                                                        {{ $product_option->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-8">
                                                {!! Form::text("language_array[".$language->language_id."][name]",
                                                    print_value(isset($_POST['language_array'][$language->language_id]['name']) ? $_POST['language_array'][$language->language_id]['name'] : !empty($result['product_option_value']->language_array[$language->language_id]['name']) ? $result['product_option_value']->language_array[$language->language_id]['name'] : '' ),
