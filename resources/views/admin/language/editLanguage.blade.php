...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/languages')}}"><i
            class="fa fa-dashboard"></i>{{ trans('labels.ListingAllLanguages') }}</a></li>
              ...
              <div class="col-xs-12">
                <div class="box box-info">
                  ...
                  <div class="box-body">
                    ...
                    {!! Form::open(array('url' =>'admin/updatelanguages', 'method'=>'post', 'class' => 'form-horizontal
                    form-validate', 'enctype'=>'multipart/form-data')) !!}
                    {!! Form::hidden('id', $result['languages'][0]->languages_id, array('class'=>'form-control',
                    'id'=>'languages_id'))!!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('name', $result['languages'][0]->name, array('class'=>'form-control
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('code', $result['languages'][0]->code, array('class'=>'form-control
                        field-validate', 'id'=>'code'))!!}
                        <span class="help-block"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        <select class="form-control field-validate" id="direction" name="direction">
                          <option value="ltr" @if($result['languages'][0]->direction=="ltr") selected
                            @endif>{{ trans('labels.RightToLeft') }}</option>
                          <option value="rtl" @if($result['languages'][0]->direction=="rtl") selected
                            @endif>{{ trans('labels.LeftToRight') }}</option>
                        </select>
                        <span class="help-block"
                          style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.LanguageDirection') }}</span>
                        <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        ...
                        <span class="help-block"
                          style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.LanguageFlag') }}</span><br>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('directory', $result['languages'][0]->directory, array('class'=>'form-control',
                        'id'=>'directory'))!!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        <select class="form-control field-validate" id="is_default" name="is_default">
                          <option value="1" @if($result['languages'][0]->is_default=="1") selected
                            @endif>{{ trans('labels.Yes') }}</option>
                          <option value="0" @if($result['languages'][0]->is_default=="0") selected
                    ...
                    <div class="box-footer text-right">
                      <div class="col-sm-offset-2 col-md-offset-3 col-sm-10 col-md-4">
                        ...
                        <a href="{{ URL::to('admin/languages')}}" type="button"
