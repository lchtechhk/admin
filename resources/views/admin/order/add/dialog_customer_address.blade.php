                ...
                <div class="box-body">        
                        ...
                        <div class="col-sm-10 col-md-9">
                            <select class="form-control select1 field-validate"  name="customer_id" id="customer_id" style="width: 100%;" {{is_disabled($result['operation'],empty($result['order']->customer_id) ? '' : $result['order']->customer_id)}}>
                                ...
                                @foreach ($result['customers'] as $customer)
                                    <option phone="<?= $customer->telephone?>" email="<?= $customer->email?>" value="{{ $customer->id }}"
                                        @if(!empty($result['order']->customer_id))
                                            {{print_selected_value($customer->id,$result['order']->customer_id)}}
                                        @endif >{{ $customer->lastname }} {{$customer->firstname}}
                                    </option>
                    ...
                    <div class="form-group" id="group_customer_company">
                        ...
                        <div class="col-sm-10 col-md-4">
                            ...
                            empty($result['order']->customer_company) ? '' : print_value($result['order']->customer_company),
                    ...
                    <div class="form-group" id="group_customer_street_address">
                        ...
                        <div class="col-sm-10 col-md-9">
                            ...
                            empty($result['order']->customer_company) ? '' : print_value($result['order']->customer_street_address),
                    ...
                    <div class="form-group" id="group_customer_telephone">
                        ...
                        <div class="col-sm-10 col-md-4">
                            ...
                            empty($result['order']->customer_telephone) ? '' : print_value($result['order']->customer_telephone),
                    ...
                    <div class="form-group" id="group_email">
                        ...
                        <div class="col-sm-10 col-md-4">
                            {!! Form::text('email', 
                            empty($result['order']->email) ? '' : print_value($result['order']->email),
